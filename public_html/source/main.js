...
//canvas
    ...
    //muzika
    var muzikaZaMenu = new Audio('zvukici/menu.wav');
    var muzikaZaIgru = new Audio('zvukici/igra.mp3');
    var maliSkok = new Audio('zvukici/maliSkok.mp3');
    var velikiSkok = new Audio('zvukici/velikiSkok.mp3');
    var boostSound = new Audio('zvukici/boost.mp3');
    var zaKraj = new Audio('zvukici/zaKraj.mp3');
    var skupi = new Audio('zvukici/skupi.mp3');
    //gumbi
    ...
    gumbZaZvuk.ontouchstart=function(){
        if (zvuk){
            ...
            gumbZaZvuk.style.backgroundImage="url('slicice/noSound.png')";
        }
        else { 
            zvuk=true;
            muzikaZaIgru.play();
            setCookie('zvuk','upaljen',30);
            gumbZaZvuk.style.backgroundImage="url('slicice/sound.png')"; //ToDo nać bolju sličicu
        }
    };
...
//pozadine
    ...
    for (let i=0;i<=6;i++){
        ...
        pozadine[i].src='slicice/pozadina'.concat(String(i),'.png');
    }
...
//Izbor slike za duha
        ...
        if (brzinaDuha===0.35) duhDesno.src='slicice/duhDesnoMedium.png';
        else if(brzinaDuha===0.5)duhDesno.src='slicice/duhDesnoHard.png';
        else duhDesno.src='slicice/duhDesno.png';
        var duhLijevo=new Image();
        if (brzinaDuha===0.35) duhLijevo.src='slicice/duhLijevoMedium.png';
        else if(brzinaDuha===0.5)duhLijevo.src='slicice/duhLijevoHard.png';
        else duhLijevo.src='slicice/duhLijevo.png';
        var duh=duhDesno;
        makniGumbeZaMeni();
        postaviGumbeZaIgru();
        if(!Igrac.mrtav)requestAnimationFrame(azuriraj);
        ...
        function nacrtaj(){
            ...
            if (Igrac.mrtav){
                ...
                if(Duh.ubrzava>0)ctx.fillText('Ghost speed increased',Duh.X,Duh.Y);
                //crtanje zvjezdice
                animirajZvjezdicu();
    ...
    function pomoc(){
        ...
        function funkcijaZaEventHandler(){ 
            if(count<svaPomoc.length){
                ...
                ctx.fillText('tap to continue',sirinaCanvasa*0.1+20,visinaCanvasa*0.1);
                count++;
            }
            else {
                ctx.clearRect(0, 0, sirinaCanvasa,visinaCanvasa);
    ...
    function otvoriPostavke(){
        ...
        postaviGumb(gumbDiffMedium,36,60);
        ...
        postaviGumb(gumbDiffHard,64,60);
        ...
        gumbZatvoriPostavke.ontouchstart=function(){
            ...
            if (brzinaDuha===0.2){
                setCookie('brzinaDuha','easy',30);
            }
            else if (brzinaDuha===0.35){
                  setCookie('brzinaDuha','medium',30);        
            }
            else{
                setCookie('brzinaDuha','hard',30);
            }
        } ;  
        //obojaj pozadinu
        obojajPozadinu();
    ...
    function postaviGumbeZaIgru(){
        ...
        if(zvuk) gumbZaZvuk.style.backgroundImage="url('slicice/sound.png')";
        else gumbZaZvuk.style.backgroundImage="url('slicice/noSound.png')";
    }
